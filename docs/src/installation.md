...
[EquationOfStateRecipes](https://github.com/MineralsCloud/EquationOfStateRecipes.jl).
...
## Install EquationOfStateRecipes
...
version of EquationOfStateRecipes, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/EquationOfStateRecipes.jl"
```

in the second step above.

## Update EquationOfStateRecipes
...
our [GitHub repository](https://github.com/MineralsCloud/EquationOfStateRecipes.jl)
for new releases.
Once we release a new version, you can update EquationOfStateRecipes by typing
...
## Uninstall and reinstall EquationOfStateRecipes
...
2. Press `ctrl+d` to quit the current session. Start a new Julia session and
   reinstall EquationOfStateRecipes.
