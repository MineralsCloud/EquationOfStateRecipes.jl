...
Another way to contribute to EquationOfStateRecipes is to file
...
Then go to [our pull request page](https://github.com/MineralsCloud/EquationOfStateRecipes.jl/pulls)
