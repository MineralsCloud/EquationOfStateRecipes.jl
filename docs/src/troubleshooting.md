...
[discuss with us](https://github.com/MineralsCloud/EquationOfStateRecipes.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/MineralsCloud/EquationOfStateRecipes.jl/issues/new) or
[submit a PR](https://github.com/MineralsCloud/EquationOfStateRecipes.jl/compare) with suggestions.
...
## Loading EquationOfStateRecipes
